...
export default function Initial(props: Props) {
  ...
  return (
    <InitialContainer>
      ...
      <p>
        Griô é um espaço Lorem ipsum dolor sit amet, consectetur adipiscing
      ...
      <div>
        <Buttons
          ...
          label={"Quero mentorar"}
          handleClick={handleMentee}
        />
        <Buttons
          value=""
          disabled=""
          className={"btn btn-warning"}
          label={"Quero ser mentorade"}
          handleClick={handleMentor}
        />
      </div>
    </InitialContainer>
  );
