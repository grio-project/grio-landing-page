...
class Team extends Component {
  render() {
    return (
      <div>
        <h1 className="title">QUEM ESTÁ ENVOLVIDO?</h1>

        <Row className="std-slide team-columns">
          <Col>
            <p>
              {<img src={nana_foto} alt="Nana's profile" />}
              <p className="subtitle-font">Nana da Silva</p>
              <p>Idealizadora do projeto e pessoa desenvolvedora</p>
              <p>@shebangbash natr@hey.com</p>
            </p>
          </Col>
